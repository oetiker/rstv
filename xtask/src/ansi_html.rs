...
//! The 16 base colors resolve through `tvision_rs::Color::BIOS_RGB`, so embedded
...
fn bios(i: u8) -> Col {
    let (r, g, b) = tvision_rs::Color::BIOS_RGB[(i & 0x0f) as usize];
    Col::Rgb(r, g, b)
}
...
mod tests {
    ...
    fn rgb(i: usize) -> String {
        let (r, g, b) = tvision_rs::Color::BIOS_RGB[i];
