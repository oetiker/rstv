...
- `MenuBox::new` and `menu_box_rect` raised to score 3. Remaining `CMenuView palette` row score 2 deferred to theme pass (lives in `src/theme.rs`). All other public symbols were already score 3.
