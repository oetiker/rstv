...
A keystroke is a physical [`Key`](../api/rstv/event/enum.Key.html) plus a
separate [`KeyModifiers`](../api/rstv/event/struct.KeyModifiers.html) channel,
bundled into a [`KeyEvent`](../api/rstv/event/struct.KeyEvent.html). There are
...
- [`ctrl_to_arrow`](../api/rstv/event/fn.ctrl_to_arrow.html) maps the WordStar
...
- [`hot_key`](../api/rstv/event/fn.hot_key.html) extracts the `~`-delimited
...
[`Keymap`](../api/rstv/keymap/struct.Keymap.html) maps a **chord** to a
[`Command`](../api/rstv/command/struct.Command.html) by name — the same
...
[`Resolve`](../api/rstv/keymap/enum.Resolve.html): a fully matched `Command`,
...
[`set_global`](../api/rstv/keymap/fn.set_global.html), and the editor and every
input field follow:
...
[`resolve_global`](../api/rstv/keymap/fn.resolve_global.html); you rarely call
