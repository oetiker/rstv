...
semantic [`Role`](../api/tvision-rs/theme/enum.Role.html) to a
[`Style`](../api/tvision-rs/color/struct.Style.html). No widget ever hard-codes a
...
| Type | What it is |
| ---- | ---------- |
| [`Color`](../api/tvision-rs/color/enum.Color.html) | A desired color: terminal `Default`, 4-bit `Bios`, 256-color `Indexed`, or 24-bit `Rgb`. |
| [`Style`](../api/tvision-rs/color/struct.Style.html) | A foreground `Color`, a background `Color`, and a [`Modifiers`](../api/tvision-rs/color/struct.Modifiers.html) struct-of-bools (bold, italic, underline, blink, reverse, strike). |
| [`Theme`](../api/tvision-rs/theme/struct.Theme.html) | The whole palette: a `Role → Style` map plus a [`Glyphs`](../api/tvision-rs/theme/struct.Glyphs.html) holder for the box-drawing and marker characters. |
...
[`Theme::default`](../api/tvision-rs/theme/struct.Theme.html#method.default). Each
role resolves to a definite true-color RGB via
[`Color::bios_rgb`](../api/tvision-rs/color/enum.Color.html#method.bios_rgb),
...
[`DrawCtx`](../api/tvision-rs/view/struct.DrawCtx.html); ask it for the style of a
...
about with
[`set_style`](../api/tvision-rs/theme/struct.Theme.html#method.set_style), and
install it on the running program with
[`Program::set_theme`](../api/tvision-rs/app/struct.Program.html#method.set_theme),
...
[`Style::with_modifiers`](../api/tvision-rs/color/struct.Style.html#method.with_modifiers),
or flip foreground and background with
[`reversed`](../api/tvision-rs/color/struct.Style.html#method.reversed) — which
