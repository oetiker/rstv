...
[`src/capture.rs`](../api/rstv/capture/index.html) and is driven by the one
event loop in [`Program`](../api/rstv/app/struct.Program.html).

## The stack

The event loop owns a single
[`CaptureStack`](../api/rstv/capture/struct.CaptureStack.html) — a LIFO stack
...
[`CaptureHandler`](../api/rstv/capture/trait.CaptureHandler.html) and answers
with a [`CaptureFlow`](../api/rstv/capture/enum.CaptureFlow.html):
...
A handler holds a [`ViewId`](../api/rstv/view/struct.ViewId.html) for the view
...
[`Context::push_capture`](../api/rstv/view/struct.Context.html#method.push_capture)
...
- **Window drag and resize.** Grabbing a window's title bar or a resize corner in
  the [`Frame`](../api/rstv/frame/struct.Frame.html) pushes a drag handler that
...
- **Press-and-hold across the widgets.** When you press and hold on a control,
  ...
  Roughly ten widgets rely on this — [`Button`](../api/rstv/widgets/struct.Button.html),
  [`Cluster`](../api/rstv/widgets/struct.Cluster.html),
  [`Editor`](../api/rstv/widgets/struct.Editor.html),
  [`InputLine`](../api/rstv/widgets/struct.InputLine.html),
  [`ScrollBar`](../api/rstv/widgets/struct.ScrollBar.html),
  `ListViewer`, `Outline`, the status line, the menus, and the window
  [`Frame`](../api/rstv/frame/struct.Frame.html) — each for its own gesture
