...
[`Program`](../api/rstv/app/struct.Program.html) is the engine. It owns the
...
[`Application`](../api/rstv/app/struct.Application.html) is a thin wrapper *over*
...
Calling [`run`](../api/rstv/app/struct.Program.html#method.run) spins the event
loop until a quit command ends it. For an app that needs to react to its *own*
commands, [`run_app`](../api/rstv/app/struct.Program.html#method.run_app) takes a
...
[`pump_once`](../api/rstv/app/struct.Program.html#method.pump_once): read the next
